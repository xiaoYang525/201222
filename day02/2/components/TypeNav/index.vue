            ...
            <div class="container">
                ...
                <div class="sort">
                    <div class="all-sort-list2" @click='toSearch'>
                        <div class="item" v-for="(c1,index) in categoryList2" :key='c1.categoryId'>
                            <h3>
                            ...
                            <div class="item-list clearfix">
                                <div class="subitem">
                                    <dl class="fore" v-for="c2 in c1.categoryChild" :key="c2.categoryId">
                                     ...
                                     <a href='javascript:;' :data-categoryName='c1.categoryName' :data-category2Id='c2.categoryId'>{{c2.categoryName}}</a>
