<template>
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          ...
          @click='setTrademark(`${item.tmId}:${item.tmName}`)'>{{item.tmName}}</li>
    ...
    <div class="type-wrap" v-for="(item,index) in attrsList" :key='index'>
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(tm,index) in item.attrValueList" :key='index'
          @click='$emit("addProp",`${item.attrId}:${tm}:${item.attrName}`)'>
            <a>{{tm}}</a>
          </li>
